...
-- Xóa bảng theo đúng thứ tự khóa ngoại nếu đã tồn tại
...
-- 6. Bảng Thẻ độc giả (Filtered Unique Index: Tại 1 thời điểm độc giả chỉ có đúng 1 thẻ đang hoạt động TrangThai = 1)
...
-- 8. Bảng Chi tiết phiếu mượn (UNIQUE chặn mượn 2 cuốn cùng đầu sách trong 1 phiếu)
...
-- Tạo Index tăng tốc truy vấn mượn trả và phạt
