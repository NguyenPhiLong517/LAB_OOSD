...
namespace QuanLyThuVien.Services
{
    public class DanhMucService
    {
        public DataTable LayNhanVien() =>
            Db.Query(@"SELECT MaNhanVien, Ho, Ten, Phai, NgaySinh, ChucVu, SoDienThoai FROM NhanVien ORDER BY MaNhanVien");
        ...
        public DataTable LayTheLoai() => Db.Query("SELECT MaTheLoai, TenTheLoai FROM TheLoai ORDER BY TenTheLoai");
        ...
        public KetQuaXuLy LuuTheLoai(string ma, string ten, bool capNhat)
        {
            ...
            try
            {
                ...
                return n > 0 ? KetQuaXuLy.Ok("Lưu thể loại thành công.") : KetQuaXuLy.Loi("Không có dữ liệu thay đổi.");
            }
            catch (SqlException ex)
            {
        ...
        public DataTable LayNhaXuatBan() =>
            Db.Query("SELECT MaNhaXuatBan, DiaChi, SoDienThoai FROM NhaXuatBan ORDER BY MaNhaXuatBan");
        ...
        public KetQuaXuLy LuuNhaXuatBan(string ma, string diaChi, string sdt, bool capNhat)
        {
            ...
            try
            {
                ...
                return n > 0 ? KetQuaXuLy.Ok("Lưu nhà xuất bản thành công.") : KetQuaXuLy.Loi("Không có dữ liệu thay đổi.");
            }
            catch (SqlException ex)
            {
