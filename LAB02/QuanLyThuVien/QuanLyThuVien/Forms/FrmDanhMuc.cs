...
namespace QuanLyThuVien.Forms
{
    public partial class FrmDanhMuc : Form
    {
        ...
        {
            if (!(dgvNV.CurrentRow?.DataBoundItem is DataRowView r)) return;
        ...
        {
            if (!(dgvTL.CurrentRow?.DataBoundItem is DataRowView r)) return;
        ...
        {
            if (!(dgvNXB.CurrentRow?.DataBoundItem is DataRowView r)) return;
        ...
        private bool XacNhanXoa() =>
            MessageBox.Show("Xóa dữ liệu đang chọn?", "Xác nhận", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes;
